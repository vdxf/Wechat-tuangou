...
/* harmony import */ var _nav_list_vue_vue_type_template_id_431c99f8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nav-list.vue?vue&type=template&id=431c99f8& */ 75);
/* harmony import */ var _nav_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nav-list.vue?vue&type=script&lang=js& */ 77);
...
/* harmony import */ var _nav_list_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./nav-list.vue?vue&type=style&index=0&lang=scss& */ 79);
...
var _default = {
  ...
  methods: {
    getBuyGroupList: function getBuyGroupList() {
      var _this = this;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return wx.$http.post('/api/Product/GetBuyGroupList');
              case 2:
                _yield$wx$$http$post = _context.sent;
                res = _yield$wx$$http$post.data;
                if (res.Status === 0) {
                  _this.buyGroupList = res.Data;
                }
              case 5:
              case "end":
    ...
    handleChangeNav: function handleChangeNav(index, item) {
